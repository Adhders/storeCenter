...
var _customerList = _interopRequireDefault(__webpack_require__(/*! ./pages/index/customerList/customerList.vue */ 71));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/* harmony import */ var _customerList_vue_vue_type_template_id_1d7839c9___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./customerList.vue?vue&type=template&id=1d7839c9& */ 72);
/* harmony import */ var _customerList_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./customerList.vue?vue&type=script&lang=js& */ 74);
...
/* harmony import */ var _customerList_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./customerList.vue?vue&type=style&index=0&lang=css& */ 77);
...
try {
  components = {
    tuiNavigationBar: function() {
      return __webpack_require__.e(/*! import() | components/thorui/tui-navigation-bar/tui-navigation-bar */ "components/thorui/tui-navigation-bar/tui-navigation-bar").then(__webpack_require__.bind(null, /*! @/components/thorui/tui-navigation-bar/tui-navigation-bar.vue */ 311))
    },
    tuiIcon: function() {
...
var render = function() {
  ...
  var l0 = _vm.__map(_vm.displayList, function(customer, index) {
...
//
//
var _default = { data: function data() {return { width: 350, height: 64, top: 20, pageSize: 10, loaddingMore: false, pullUpOn: true, pageNum: 1, loadding: true, displayList: [], customerList: [] };}, onLoad: function onLoad() {var _this = this;this.pid = uni.getStorageSync("pid");this.store_id = uni.getStorageSync("store_id");var url = '/getStoreAllCustomer/' + this.pid + '/' + this.store_id;this.tui.request(url).then(function (res) {_this.loadding = false;_this.customerList = res.customerList;_this.displayList = _this.customerList.slice(0, _this.pageSize);_this.pageNum = 1;_this.pullUpOn = true;_this.loaddingMore = false;});
  },
  filters: {
    formatDate: function formatDate(v) {
      return _util.default.formatDate("y-m-d", v);
    } },
  ...
  methods: {
    ...
    detail: function detail(customer) {
      var url = "/pages/index/customerDetail/customerDetail?customer=" + encodeURIComponent(JSON.stringify(customer));
      uni.navigateTo({
        url: url });
  ...
  onReachBottom: function onReachBottom() {var _this2 = this;
    ...
    if (this.pageNum >= this.customerList.length / this.pageSize) {
      ...
      setTimeout(function () {
        ...
        _this2.displayList = _this2.customerList.slice(0, _this2.pageSize * _this2.pageNum);
      }, 300);
    }
