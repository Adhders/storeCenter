...
var _customerList = _interopRequireDefault(__webpack_require__(/*! ./pages/index/customerList/customerList.vue */ 60));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/* harmony import */ var _customerList_vue_vue_type_template_id_1d7839c9___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./customerList.vue?vue&type=template&id=1d7839c9& */ 61);
/* harmony import */ var _customerList_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./customerList.vue?vue&type=script&lang=js& */ 63);
...
/* harmony import */ var _customerList_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./customerList.vue?vue&type=style&index=0&lang=css& */ 65);
...
//
//
var _default = { data: function data() {return { width: 350, height: 64, top: 20, loadding: true, customerList: [] };}, onLoad: function onLoad() {var _this = this;var url = '/getStoreCustomer/' + this.$store.state.appid;this.tui.request(url, 'GET', undefined, true).then(function (res) {_this.loadding = false;_this.customerList = res.customerList;});}, filters: { formatDate: function formatDate(v) {return _util.default.formatDate("y-m-d", v);} }, methods: { back: function back() {uni.navigateBack();}, initHeader: function initHeader(e) {console.log('e', e);this.width = Number(e.left);
