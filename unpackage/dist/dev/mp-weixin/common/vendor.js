...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    setStoreInfo: function setStoreInfo(state, storeInfo) {
      state.storeInfo = storeInfo;
    },
    setAddress: function setAddress(state, addressList) {
    ...
    setOrderList: function setOrderList(state, orderList) {
      state.orderList = orderList;
    },
    updateGoodsList: function updateGoodsList(state, goodsList) {
      state.goodsList = goodsList;
    },
    updateGoodsGroup: function updateGoodsGroup(state, goodsGroup) {
      state.goodsGroup = goodsGroup;
    },
    updateGoodsProperty: function updateGoodsProperty(state, goodsProperty) {
      state.goodsProperty = goodsProperty;
    },
    updateTagList: function updateTagList(state, goodsTag) {
...
var form = {
  ...
  /*
   ...
   rules: Array [{name:name,rule:[],msg:[],validator:[],{name:name,rule:[],msg:[],validator:[]}]
  		...
  		validator:[{msg:'错误消息',method:Function}]，自定义验证方法组，函数约定：(value)=>{ return true or false}
  */
  validation: function () {var _validation = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(formData, rules) {var _iterator, _step, item, key, rule, validator, msgArr, i, length, ruleItem, msg, value, temp, isError, range, _iterator2, _step2, model, func;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_iterator = _createForOfIteratorHelper(
              rules);_context.prev = 1;_iterator.s();case 3:if ((_step = _iterator.n()).done) {_context.next = 114;break;}item = _step.value;
              key = item.name;
              rule = item.rule;
              validator = item.validator;
              msgArr = item.msg;if (!(
              !key || !rule || rule.length === 0 || !msgArr || msgArr.length === 0 || !~rule.indexOf(
              "required") && formData[key].toString().
              length === 0)) {_context.next = 11;break;}return _context.abrupt("continue", 112);case 11:


              i = 0, length = rule.length;case 12:if (!(i < length)) {_context.next = 81;break;}
              ruleItem = rule[i];
              msg = msgArr[i];if (!(
              !msg || !ruleItem)) {_context.next = 17;break;}return _context.abrupt("continue", 78);case 17:
              //数据处理
              value = null;
              if (~ruleItem.indexOf(":")) {
                temp = ruleItem.split(":");
              ...
              isError = false;_context.t0 =
              ruleItem;_context.next = _context.t0 ===
              "required" ? 23 : _context.t0 ===


              "isMobile" ? 25 : _context.t0 ===


              "isEmail" ? 27 : _context.t0 ===


              "isCarNo" ? 29 : _context.t0 ===


              "isIdCard" ? 31 : _context.t0 ===


              "isAmount" ? 33 : _context.t0 ===


              "isNum" ? 35 : _context.t0 ===


              "isChinese" ? 37 : _context.t0 ===


              "isNotChinese" ? 39 : _context.t0 ===


              "isEnglish" ? 41 : _context.t0 ===


              "isEnAndNo" ? 43 : _context.t0 ===


              "isEnOrNo" ? 45 : _context.t0 ===


              "isSpecial" ? 47 : _context.t0 ===


              "isEmoji" ? 49 : _context.t0 ===


              "isDate" ? 51 : _context.t0 ===


              "isUrl" ? 53 : _context.t0 ===


              "isSame" ? 55 : _context.t0 ===


              "range" ? 57 : _context.t0 ===
              ...
              "minLength" ? 69 : _context.t0 ===


              "maxLength" ? 71 : _context.t0 ===


              "isKeyword" ? 73 : 75;break;case 23:isError = form._isNullOrEmpty(formData[key]);return _context.abrupt("break", 76);case 25:isError = !form._isMobile(formData[key]);return _context.abrupt("break", 76);case 27:isError = !form._isEmail(formData[key]);return _context.abrupt("break", 76);case 29:isError = !form._isCarNo(formData[key]);return _context.abrupt("break", 76);case 31:isError = !form._isIdCard(formData[key]);return _context.abrupt("break", 76);case 33:isError = !form._isAmount(formData[key]);return _context.abrupt("break", 76);case 35:isError = !form._isNum(formData[key]);return _context.abrupt("break", 76);case 37:isError = !form._isChinese(formData[key]);return _context.abrupt("break", 76);case 39:isError = !form._isNotChinese(formData[key]);return _context.abrupt("break", 76);case 41:isError = !form._isEnglish(formData[key]);return _context.abrupt("break", 76);case 43:isError = !form._isEnAndNo(formData[key]);return _context.abrupt("break", 76);case 45:isError = !form._isEnOrNo(formData[key]);return _context.abrupt("break", 76);case 47:isError = form._isSpecial(formData[key]);return _context.abrupt("break", 76);case 49:isError = form._isEmoji(formData[key]);return _context.abrupt("break", 76);case 51:isError = !form._isDate(formData[key]);return _context.abrupt("break", 76);case 53:isError = !form._isUrl(formData[key]);return _context.abrupt("break", 76);case 55:isError = !form._isSame(formData[key], formData[value]);return _context.abrupt("break", 76);case 57:range = null;_context.prev = 58;range = JSON.parse(value);if (!(range.length <= 1)) {_context.next = 62;break;}throw new Error("range值传入有误！");case 62:_context.next = 67;break;case 64:_context.prev = 64;_context.t1 = _context["catch"](58);return _context.abrupt("return", "range值传入有误！");case 67:isError = !form._isRange(formData[key], range[0], range[1]);return _context.abrupt("break", 76);case 69:isError = !form._minLength(formData[key], value);return _context.abrupt("break", 76);case 71:isError = !form._maxLength(formData[key], value);return _context.abrupt("break", 76);case 73:
              isError = !form._isKeyword(formData[key], value);return _context.abrupt("break", 76);case 75:return _context.abrupt("break", 76);case 76:if (!




              isError) {_context.next = 78;break;}return _context.abrupt("return",
              msg);case 78:i++;_context.next = 12;break;case 81:if (!(


              validator && validator.length > 0)) {_context.next = 112;break;}_iterator2 = _createForOfIteratorHelper(
              validator);_context.prev = 83;_iterator2.s();case 85:if ((_step2 = _iterator2.n()).done) {_context.next = 104;break;}model = _step2.value;
              console.log('model', model);
              func = model.method;_context.t2 =
              console;_context.next = 92;return func(formData[key]);case 92:_context.t3 = !_context.sent;_context.t2.log.call(_context.t2, _context.t3);_context.t4 =
              func;if (!_context.t4) {_context.next = 99;break;}_context.next = 98;return func(formData[key]);case 98:_context.t4 = !_context.sent;case 99:if (!_context.t4) {_context.next = 102;break;}
              console.log('msg', model.msg);return _context.abrupt("return",
              model.msg);case 102:_context.next = 85;break;case 104:_context.next = 109;break;case 106:_context.prev = 106;_context.t5 = _context["catch"](83);_iterator2.e(_context.t5);case 109:_context.prev = 109;_iterator2.f();return _context.finish(109);case 112:_context.next = 3;break;case 114:_context.next = 119;break;case 116:_context.prev = 116;_context.t6 = _context["catch"](1);_iterator.e(_context.t6);case 119:_context.prev = 119;_iterator.f();return _context.finish(119);case 122:return _context.abrupt("return",




              "");case 123:case "end":return _context.stop();}}}, _callee, null, [[1, 116, 119, 122], [58, 64], [83, 106, 109, 112]]);}));function validation(_x, _x2) {return _validation.apply(this, arguments);}return validation;}(),
